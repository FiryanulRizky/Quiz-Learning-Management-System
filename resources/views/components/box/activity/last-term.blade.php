                ...
                <div class="row no-gutters align-items-center">
                    <div class="col mr-4">
                        <div class="row">
                            ...
                            <div class="col-4">
                                <h6 class="font-weight-bold text-dark">{{ __('Berikutnya') }}</h6>
                                <p class="text-dark">
                                    <i class="fa fa-flag-checkered"></i>
                                    <a href="" class="">Sasaran Modul Sebelumnya</a>
                                </p>
                                <small class="text-secondary">minggu ke-2 | Waktu Diskusi * 10 menit</small>
