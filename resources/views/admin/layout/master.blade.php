...
<html>
  <head>
    ...
    <title>E-Learning PT. Trans Continent</title>
    ...
    <!-- jika trainee maka pake layout-top-nav -->
    ...
    <div class="wrapper">      
      ...
      @elseif(Auth::user()->level==12)
        @include('admin.include.sidebar_trainer')
      @elseif(Auth::user()->level==13)
        @include('admin.include.sidebar_trainee')
      @endif
