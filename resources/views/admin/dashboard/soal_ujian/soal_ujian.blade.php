            ...
            <div class="col-xs-12">
              <div class="box box-danger">
                <div class="box-header with-border">
                  ...
                  <?php endif ?>
                  <?php if (Auth::user()->level  == 12): ?>
                    <h3 class="box-title">Tambah Soal Ujian <a href="{{{ URL::to('trainer/tambah_soal_ujian') }}}" class="btn btn-success btn-flat btn-sm" id="tambahSoalUjian" title="Tambah Soal Ujian"><i class="fa fa-plus"></i></a></h3>                  
                  <?php endif ?>
                </div><!-- /.box-header -->
