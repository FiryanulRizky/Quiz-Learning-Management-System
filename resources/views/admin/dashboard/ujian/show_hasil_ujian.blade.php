...
@section('breadcrump')
          <h1>
            Detail Jawaban {{ $ujian->jenis_ujian }} Trainee
          ...
          <?php endif ?> 
            <li class="active">Detail Jawaban {{ $ujian->jenis_ujian }} Trainee</li>
          </ol>
@stop
@section('content')          
          <div class="row">
            <div class="col-md-12">
              <div class="box box-danger">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h4 class="panel-title">
                                <a data-toggle="collapse" data-parent="#accordion" href="#{{$jawab->id_trainee_jawab_ujian_pilgan}}" id="btnPopover6" title="{{$jawab->is_kosong ? 'Jawaban Kosong' : ($jawab->is_benar ? 'Jawaban Benar' : 'Jawaban Salah') }}" >
                                    @if ($jawab->is_kosong)
                        ...
                        <div id="{{$jawab->id_trainee_jawab_ujian_pilgan}}" class="panel-collapse collapse">
                ...
                @else                                                  
                <?php if (Auth::user()->level == 11 ): ?> 
                  <a href="{{ url('admin/trainee_ujian/'.$userjawabujian->id_ujian) }}"
                     class="btn btn-success pull-right">
                <?php endif ?>
                 <?php if (Auth::user()->level == 12): ?> 
                  <a href="{{ url('trainer/trainee_ujian/'.$userjawabujian->id_ujian) }}"
                     class="btn btn-success pull-right">
                <?php endif ?>
                <?php if (Auth::user()->level == 13): ?>
                  <a href="{{ url('trainee/trainee_ujian/'.$userjawabujian->id_ujian) }}"
                     class="btn btn-success pull-right">
                <?php endif ?>
