...
@section('breadcrump')
          ...
          <?php if ( Auth::user()->level  == 13): ?>
            <h1>Ujian Online departemen "{{ $trainee->departemen_trainee }}"
          <?php endif ?>
          ...
          <?php if (Auth::user()->level  == 13): ?>
            ...
            <li class="active">Ujian Online departemen "{{ $trainee->departemen_trainee }}"</li> 
          <?php endif ?>           
          </ol>
@stop
          ...
          <div class="row">
            <div class="col-xs-12">
              ...
              <div class="box box-danger">                
                  <div class="box-header with-border">
                    ...
                    <?php endif ?>
                    <?php if (Auth::user()->level  == 12): ?>
                      <h3 class="box-title">Tambah Ujian <a href="{{{ URL::to('trainer/tambahujian') }}}" class="btn btn-success btn-flat btn-sm" id="tambahUjian" title="Tambah"><i class="fa fa-plus"></i></a></h3>
                    <?php endif ?>
                  </div><!-- /.box-header -->                  
                    ...
                    <tbody>
                     <?php $i=1; foreach ($ujian as $dataUjian):  ?>
                      <tr>
                        ...
                        <td>{{$dataUjian->nama_modul}}</td> 
                        <td>{{$dataUjian->departemen_ujian}}</td>
            ...
            <div class="box box-danger">
              ...
              <div class="box-body" style="display: block;">
                ...
                <table id="dataTabelUjianTrainee" class="table table-striped table-responsive">
                  <thead>
                    <th>No</th>
                    <th>Modul</th> 
                    <th>Judul</th>
                  ...
                  <tbody>
                  <?php $i=1; foreach ($ujianTrainee as $dataUjian):  ?>                  
                  <tr>
                    <td>{{$i}}</td> 
                    <td>{{$dataUjian->nama_modul}}</td> 
                    <td>{{$dataUjian->judul_ujian}}</td>
            ...
            @if (!$userJawabLembars->isEmpty())
            <table id="dataTabelPengambilanUjianTrainee" class="table table-striped table-responsive">
                <thead>
                <th>No</th>
                <th>Modul</th>
                <th>Jenis Ujian</th>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="{{{ URL::to('trainee/ujian/'.$userJawabLembar->id_nilai_ujian_pilgan) }}}"
                           class="btn btn-primary btn-xs">
                            <span class="glyphicon glyphicon-eye-open"></span> Lihat
                        </a>                                             
                        <a href="{{action('Admin\TraineeJawabUjianController@show', array($userJawabLembar->id_ujian))}}"
...
<script>
      $(function () {
        ...
        $('#dataTabelUjianTrainee').DataTable({"pageLength": 10, "scrollX": true});
        $('#dataTabelPengambilanUjianTrainee').DataTable({"pageLength": 10, "scrollX": true});
      });
