            ...
            <div class="col-md-12">
              <div class="box box-danger">
                ...
                <!-- Jawaban group-->
                  <blockquote style="font-size: 12pt">
                      ...
                      <p>4. Jika mati lampu, segera hubungi trainer modul terkait untuk melakukan ujian ulang.</p>
                  </blockquote>
              ...
              <?php if (Auth::user()->level  == 11): ?>
                <div class="pull-right clearfix">
                  <a href="{{{ URL::to('admin/trainee_ujian/'.$id_ujian) }}}" class="btn btn-success">
              ...
              <?php if (Auth::user()->level  == 12): ?>
                <div class="pull-right clearfix">
                  <a href="{{{ URL::to('trainer/trainee_ujian/'.$id_ujian) }}}" class="btn btn-success">
                      <span class="glyphicon glyphicon-align-left"></span> Lihat Ranking
                  </a>
                </div>                            
              <?php endif ?>
                
                <form id="formTraineeUjian" class="form-horizontal" role="form" method="POST" action="{{ url('trainee/ujian') }}" >
                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                <input type="hidden" name="id_ujian" value="{{$id_ujian}}" >                
              <?php if (Auth::user()->level  == 13): ?>  
                <div class="pull-right clearfix">
                  <a href="{{{ URL::to('trainee/trainee_ujian/'.$id_ujian) }}}" class="btn btn-success">
                      <span class="glyphicon glyphicon-align-left"></span> Lihat Ranking
                  </a>
                </div>
                <div class="clearfix">
