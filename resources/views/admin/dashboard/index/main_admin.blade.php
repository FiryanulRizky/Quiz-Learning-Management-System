    ...
    <div class="row">
            ...
            <div class="col-lg-3 col-xs-6">
              ...
              <div class="small-box bg-blue"> 
                ...
                <a href="{{url('admin/materi_modul')}}" class="small-box-footer" data-toggle="tooltip" data-title="Kelola Modul Menu">More info <i class="fa fa-arrow-circle-right"></i></a>
              </div>
            </div><!-- ./col -->
            <div class="col-lg-3 col-xs-6">
              <!-- small box -->
            ...
            <div class="col-lg-3 col-xs-6">
              ...
              <div class="small-box bg-purple">
                ...
                <a href="{{url('admin/soal_quiz')}}" class="small-box-footer" data-toggle="tooltip" data-title="Kelola Soal Quiz">More info <i class="fa fa-arrow-circle-right"></i></a>
              </div>
            </div><!-- ./col -->
            <div class="col-lg-3 col-xs-6">
              <!-- small box -->
              <div class="small-box bg-purple">
                ...
                <a href="{{url('admin/quiz')}}" class="small-box-footer" data-toggle="tooltip" data-title="Kelola Quiz">More info <i class="fa fa-arrow-circle-right"></i></a>
              </div>
            </div><!-- ./col -->
  </div>
