                     ...
                     <?php $i=1; foreach ($user as $dataUser):  ?>
                      <tr>
                        ...
                        <td>
                          ...
                          <a href="{{{ action('AdminController@hapus',[$dataUser->id_user]) }}}" title="hapus"   onclick="return confirm('Apakah anda yakin akan menghapus Data Trainee {{{($dataUser->id_user).' - '.($dataUser->name) }}}?')">
