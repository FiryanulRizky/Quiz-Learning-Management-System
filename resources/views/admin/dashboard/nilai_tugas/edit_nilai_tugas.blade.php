...
@section('content')
        ...
        <div style="display: block; " class="box-body">                         
                       <form id="formNilaiTugasEdit" class="form-horizontal" role="form" method="POST" action="{{ url('admin/nilai_tugas/'.$id_nilai_tugas_trainee.'/simpanedit') }}">
                      <input type="hidden" name="_token" value="{{ csrf_token() }}">
                      <input type="hidden" name="_method" value="PUT">
                      <input type="hidden" name="id_nilai_tugas_trainee" value="{{$id_nilai_tugas_trainee}}" >
