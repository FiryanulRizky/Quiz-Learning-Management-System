...
@section('breadcrump')
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Quiz Online</li>
          </ol>
@stop
@section('content') 
...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        ...
        'Admin\SoalQuizController@update', $userjawablembar->id_nilai_quiz_pilgan, $soal[0]->id_soal )) ) }}
        ...
        <div class="list-group">
            <a class="list-group-item well-lg">
                {{Form::radio('jawaban', $soal[0]->id_jawaban_soal_quiz)}}
                &nbsp;
                <strong>A.</strong> {{$soal[0]->jawaban}}
            </a>
            <a class="list-group-item well-lg">
                {{Form::radio('jawaban', $soal[1]->id_jawaban_soal_quiz)}}
                &nbsp;
                <strong>B.</strong> {{$soal[1]->jawaban}}
            </a>
            <a class="list-group-item well-lg">
                {{Form::radio('jawaban', $soal[2]->id_jawaban_soal_quiz)}}
                &nbsp;
            ...
            <a class="list-group-item well-lg">
                {{Form::radio('jawaban', $soal[3]->id_jawaban_soal_quiz)}}
                &nbsp;
        ...
        <div class="pull-right clearfix">
            @if (!$is_last_soal)
            <a href="{{action('Admin\SoalQuizController@show', array($userjawablembar->id_nilai_quiz_pilgan, $next_soal))}}"
