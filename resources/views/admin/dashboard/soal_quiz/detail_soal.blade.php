...
@section('breadcrump')
          ...
          <?php endif ?>  
            <li class="active">Detail Soal Quiz </li>
          </ol>
@stop
@section('content')         
          <div class="row">
            <div class="col-md-12">
              <div class="box box-danger">
                <div class="box-header with-border">
                  <div class="pull-left"> 
                    <h3 class="box-title">Detail Soal {{ $quiz[0]->judul_quiz }}</h3>                  
                  </div>   
                  <div class="pull-right"> 
                    ...
                    <a href="{{{ URL::to('admin/soal_quiz/'.$id_soal.'/edit') }}}" class="btn btn-warning btn-xs">
                       <span class="glyphicon glyphicon-edit" ></span> Edit 
                    </a> 
                    @elseif(Auth::user()->level  == 12)
                    <a href="{{{ URL::to('trainer/soal_quiz/'.$id_soal.'/edit') }}}" class="btn btn-warning btn-xs">
                      <span class="glyphicon glyphicon-edit" ></span> Edit 
                   </a>
                   @endif
                    <a href="{{{ action('Admin\SoalQuizController@hapus',[$id_soal]) }}}" title="hapus"   onclick="return confirm('Apakah anda yakin akan menghapus data {{{($pertanyaan).' - '.($quiz[0]->judul_quiz) }}}?')" class="btn btn-danger btn-xs">
                  ...
                  <div class="row"> 
                    @if($jenis_soal == 'Pilihan Ganda')
                      ...
                      <?php if ($soal[0]->gambar == ""): ?>
                        <!-- Jika gambar di database soal quiz  "tidak ada" tampilkan pertanyaan  -->
                      ...
                      <?php endif ?>
                      <?php if (!$soal[0]->gambar == ""): ?>
                        <!-- Jika gambar di database soal quiz "ada" tampilkan gambar dan pertanyaan -->
                        <!--  gambar -->
                          <div class="form-group" >                                            
                            <div class="col-md-3">
                              <br>
