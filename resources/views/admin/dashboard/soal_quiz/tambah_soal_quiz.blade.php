...
@section('breadcrump')
          ...
          <ol class="breadcrumb">
            ...
            <?php endif ?>
              <li class="active">Tambah Data Soal Quiz</li>
          </ol>
@stop
@section('content')
          <div class="row">
    ...
    <div class="box box-danger">
      ...
      <div class="pull-left"> 
        <h3 class="box-title"> Form Tambah Data Soal Quiz</h3>
      </div>   
    ...
    <div style="display: block;" class="box-body">
      ...
      <form id="formSoalQuizTambah" class="form-horizontal" role="form" method="POST" enctype="multipart/form-data" action="{{ url('admin/soal_quiz/tambah') }}" >
      @elseif(Auth::user()->level  == 12)
      <form id="formSoalQuizTambah" class="form-horizontal" role="form" method="POST" enctype="multipart/form-data" action="{{ url('trainer/soal_quiz/tambah') }}" >
      @endif
                ...
                <!-- general left form elements -->              
                    ...
                    <div class="form-group">                     
                     <label for="gambar">Gambar</label>                     
                        <input type="file" id="gambar" name="gambar" value="{{ old('id_quiz') }}">
                  ...
                  <div class="col-md-12">                    
                     <label for="id_quiz">ID Quiz</label>          
                      <select class="form-control " name="id_quiz">
                       <option value="{{ old('id_quiz') }}">-- Pilih ID Quiz --</option>
              ...
              <div class="form-group"> 
                 <div class="col-md-8 col-md-offset-5">
                   <button type="submit" class="btn btn-primary" id="button-reg">
                    ...
                    <a href="{{{ action('Admin\SoalQuizController@index') }}}" title="Cancel">
