...
@section('breadcrump')
          ...
          <?php endif ?> 
            <li class="active">Edit Data Materi Ajar</li>
          </ol>
@stop
@section('content')
          <div class="row">
            <div class="col-md-12">
                ...
                <div class="box box-danger">
                  <div class="box-header">
                    <h3 class="box-title">Form Edit Data Materi Ajar</h3>
                </div><!-- /.box-header -->
                  <div class="box-body no-padding">                      
                      <?php if ( Auth::user()->level  == 11): ?>
                        <form id="formMateriAjarEdit" class="form-horizontal" role="form" method="POST" enctype="multipart/form-data" action="{{ url('admin/materi_ajar/'.$id_materi_ajar.'/simpanedit') }}" >
                      <?php endif ?>

                      <?php if (Auth::user()->level  == 12): ?>                        
                        <form id="formMateriAjarEdit" class="form-horizontal" role="form" method="POST" enctype="multipart/form-data" action="{{ url('trainer/materi_ajar/'.$id_materi_ajar.'/simpanedit') }}" >
                      <?php endif ?> 
                      <input type="hidden" name="_token" value="{{ csrf_token() }}">
                      <input type="hidden" name="_method" value="PUT">
                      <input type="hidden" name="id_materi_ajar" value="{{$id_materi_ajar}}" > 
                      ...
                      <div style="display: block;" class="box-footer" >
                        <div class="form-group">
                          <div class="col-md-8 col-md-offset-5">
                              ...
                              <?php if (Auth::user()->level  == 12): ?>
                                <a href="{{{ url('trainer/materi_ajar') }}}" title="Cancel">
                                <span class="btn btn-default"><i class="fa fa-back"> Cancel </i></span>
                                </a> 
                              <?php endif ?>   
                          </div>
