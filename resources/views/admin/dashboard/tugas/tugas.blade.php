                    ...
                    <tbody>
                     <?php $i=1; foreach ($tugas as $dataTugas):  ?>
                      <tr>
                        ...
                        <td>{{$dataTugas->departemen_tugas}}</td>
                    ...
                    <tbody>
                     <?php $i=1; foreach ($tugas as $dataTugas):  ?>
                      <tr>
                        ...
                        <td>{{$dataTugas->info_tugas}}</td>
                        <td> 
                          <?php if ($trainee->departemen_trainee == $dataTugas->departemen_tugas): ?>                            
                            <a href="{{{ URL::to('trainee/tugas/'.$dataTugas->id_tugas.'/detail_tugas_trainee') }}}"
