...
@section('content')
          ...
          <div class="col-md-12">
           ...
           <div class="box box-danger">
              ...
              <h3 class="box-title"> Form Edit Data Nilai Quiz</h3>              
           </div>

        <div style="display: block; " class="box-body">                         
            <form id="formNilaiQuizEdit" class="form-horizontal" role="form" method="POST" action="{{ url('admin/nilai_quiz/'.$id_nilai_quiz_trainee.'/simpanedit') }}">
                      <input type="hidden" name="_token" value="{{ csrf_token() }}">
                      <input type="hidden" name="_method" value="PUT">
                      <input type="hidden" name="id_nilai_quiz_trainee" value="{{$id_nilai_quiz_trainee}}" >                                                
                       ...
                       <div class="col-md-8">               
                        <select class="form-control " name="id_tugas" style="font-size: 14px; text-align: left;">
                         ...
                         @foreach ($Quiz as $idQuiz)
                            <option value="{{ $idQuiz->id_tugas }}">id quiz : {{ $idQuiz->id_quiz }} | judul: {{ $idQuiz->judul_quiz }}</option>
                         @endforeach                                                                                 
                        </select>
                       </div>   
                      </div>
                      ...
                      <div class="form-group">
                       ...
                       <div class="col-md-8">               
                         <input type="text" class="form-control" name="nilai_quiz" value="{{$nilai_quiz}}">
