...
@section('content')
  <div class="row">
    ...
    <div class="box-header with-border">
      <h3 class="box-title"> Form Tambah Data Trainer</h3>              
    </div>
    
    <div style="display: block;" class="box-body">
      <form id="formTrainerTambah" class="form-horizontal" role="form" method="POST"  enctype="multipart/form-data" action="{{ url('admin/trainer/tambah') }}" >
        <input type="hidden" name="_token" value="{{ csrf_token() }}">
          ...
          <div class="col-md-6">
            ...
            <div class="form-group">
                <label class="col-sm-4 control-label" style="text-align: left;">NIK</label>
                 <div class="col-sm-8">                  
                    <input type="text" class="form-control" name="nik_trainer" value="" placeholder="NIK">
              ...
              <div class="form-group">
                <label class="col-sm-4 control-label" style="text-align: left;">Nama</label>
                 <div class="col-sm-8">                  
                    <input type="text" class="form-control" name="nama_trainer" value="" placeholder="Nama">
                    <small class="help-block"></small>            
                </div>  
              </div>
              ...
              <div class="form-group" style="height: 42px">
                 ...
                 <div class="col-sm-8">                  
                    <input type="text" class="form-control" name="ttl_trainer" value="" placeholder="Tempat Tanggal Lahir">
                    <small class="help-block"></small>
                 </div>
              </div> 
              ...
              <div class="form-group">
                <label class="col-sm-4 control-label" style="text-align: left;">Nomor HP</label>
                 <div class="col-sm-8">                  
                    <input type="text" class="form-control" name="no_telp_trainer" value="" placeholder="Nomor HP">
                    <small class="help-block"></small>
                 </div>
               </div>
               ...
               <label class="col-sm-4 control-label" style="text-align: left;">Email</label>
                 <div class="col-sm-8">                  
                    <input type="text" class="form-control" name="email_trainer" value="" placeholder="Email">
                    <small class="help-block"></small>
                 </div>
               </div>
          </div>
          ...
          <div class="col-md-6">
            ...
            <div class="form-group">
                 ...
                 <div class="col-sm-8">
                  <textarea class="form-control" name="alamat_trainer" placeholder="Alamat" style="height: 90px"></textarea>                              
                  <small class="help-block"></small>
                 </div>
               </div>                 
               ...
               <div class="form-group">
                 ...
                 <div class="col-sm-8">                  
                    <input type="text" class="form-control" name="jabatan_trainer" value="" placeholder="Jabatan Trainer">
                    <small class="help-block"></small>
                 </div>
                </div>
                ...
                <div class="form-group">
                 ...
                 <div class="col-sm-8">               
                  <select class="form-control " name="status_trainer" style="font-size: 14px; text-align: left;">
                   <option>-- Pilih Status Trainer --</option>
                ...
                <div class="form-group">
                 ...
                 <div class="col-sm-8">               
                  <select class="form-control " name="id_user" style="font-size: 14px; text-align: left;">
                   <option>-- Pilih ID User Trainer --</option>
