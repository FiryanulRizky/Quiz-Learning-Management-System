...
<div class="col-12">
    <div class="card shadow mb-4 border-bottom-primary">
        ...
        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
            <h6 class="m-0 font-weight-bold text-primary">{{ __("Tambah file") }}</h6>
                    ...
                    <div class="row">
                        <div class="col-sm-6 mb-3 mb-sm-0">
                            <div class="form-group">
                                ...
                                <input name="title" type="text" class="form-control form-control-user" id="title" placeholder="Nama" value="{{ $file->title ?? '' }}">
                            </div>
