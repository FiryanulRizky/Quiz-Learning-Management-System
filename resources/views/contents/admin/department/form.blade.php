...
<div class="col-12">
    <div class="card shadow mb-4 border-bottom-primary">
        ...
        <div
            ...
            <h6 class="m-0 font-weight-bold text-primary">{{ __("Tambah Departemen Baru") }}</h6>
                ...
                @endif
                    ...
                    <div class="form-group row">
                        <div class="col-sm-6 mb-3 mb-sm-0">
                            <input name="title" type="text" class="form-control form-control-user" id="title"
                                placeholder="Nama Departemen" value="{{ $department->title ?? '' }}">
                            @error('title')
                        ...
                        <div class="col-sm-6">
                            <input name="image" type="text" class="form-control form-control-user" id="image"
                                placeholder="Upload Gambar" value="{{ $department->image ?? '' }}">
                            @error('image')
                                <span class="invalid-feedback" role="alert">
                                    {{ $message }}
                                </span>
                    ...
                    <div class="form-group">
                        <textarea name="description" type="text" class="form-control editor" id="description"
                            placeholder="Deskripsi">{{ $department->description ?? '' }}</textarea>
                        @error('description')
                            <span class="invalid-feedback" role="alert">
                                {{ $message }}
                            </span>
