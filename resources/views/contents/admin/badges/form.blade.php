...
<div class="col-12">
    <div class="card shadow mb-4 border-bottom-primary">
        ...
        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
            <h6 class="m-0 font-weight-bold text-primary">{{ __("Tambah Penghargaan") }}</h6>
        ...
        <div class="card-body">
            ...
            <form class="user" method="POST" action="{{ route('badges.update' , $badge->id) }}">
                ...
                <form class="user" method="POST" action="{{ route('badges.store') }}">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input name="title" type="text" class="form-control form-control-user" id="title" placeholder="Nama" value="{{ $badge->title ?? '' }}">
                            </div>
                            <div class="form-group">
                    ...
                    <div class="form-group">
                        <textarea name="description" type="text" class="form-control editor" id="description" placeholder="Deskripsi">{{ $badge->description ?? '' }}</textarea>
                    </div>
