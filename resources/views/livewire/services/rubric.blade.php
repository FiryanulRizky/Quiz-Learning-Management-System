<div class="col-12 text-left mt-4 p-4">
    ...
    <div class="form-group">
        <label for="titleofrubric">nama</label>
        <input type="text" class="form-control" id="titleofrubric" wire:model="title">
        @error('title') <span class="error">{{ $message }}</span> @enderror
    </div>
    <div class="form-group">
        <label for="descriptionofrubric">deskripsi rubrik</label>
    ...
    <div class="row mb-4 p-2 border-bottom-secondary">
        ...
        <div class="col-sm">
            @if($loop->first)
            <label for="title{{ $index }}">Nama</label>
            @endif
        ...
        <div class="col-sm">
            <textarea placeholder="detail" class="form-control" type="text" wire:model="bodies.{{ $index }}.cells.{{ $cell_index }}.title"></textarea>
            <br/>
