      ...
      <div class="box-body">
        <div class="row"> 
          ...
          <?php if (Auth::user()->level  == 12): ?>
            <form class="form-horizontal" role="form" method="POST" action="{{ url('trainer/trainer/simpanubahpassworduser') }}">
          <?php endif ?>  

          <?php if (Auth::user()->level  == 13): ?>
            <form class="form-horizontal" role="form" method="POST" action="{{ url('trainee/trainee/simpanubahpassworduser') }}">
          <?php endif ?>            
