...
-- Dumping database structure for e-learning
CREATE DATABASE IF NOT EXISTS `e-learning` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `e-learning`;

-- Dumping structure for table e-learning.departemen
...
-- Dumping data for table e-learning.departemen: ~0 rows (approximately)

-- Dumping structure for table e-learning.departemen_have_moduls
...
-- Dumping data for table e-learning.departemen_have_moduls: ~0 rows (approximately)
...
-- Dumping structure for table e-learning.jawaban_soal_quizs
...
-- Dumping data for table e-learning.jawaban_soal_quizs: ~8 rows (approximately)
...
-- Dumping structure for table e-learning.materi_moduls
...
-- Dumping data for table e-learning.materi_moduls: ~12 rows (approximately)
...
-- Dumping structure for table e-learning.messages
...
-- Dumping data for table e-learning.messages: ~0 rows (approximately)

-- Dumping structure for table e-learning.migrations
...
-- Dumping data for table e-learning.migrations: ~0 rows (approximately)
...
-- Dumping structure for table e-learning.moduls
...
-- Dumping data for table e-learning.moduls: ~12 rows (approximately)
...
-- Dumping structure for table e-learning.nilai_quiz_essay_trainees
...
-- Dumping data for table e-learning.nilai_quiz_essay_trainees: ~0 rows (approximately)

-- Dumping structure for table e-learning.nilai_quiz_pilgan_trainees
...
-- Dumping data for table e-learning.nilai_quiz_pilgan_trainees: ~0 rows (approximately)

-- Dumping structure for table e-learning.nilai_quiz_trainees
...
-- Dumping data for table e-learning.nilai_quiz_trainees: ~0 rows (approximately)

-- Dumping structure for table e-learning.nilai_trainees
...
-- Dumping data for table e-learning.nilai_trainees: ~0 rows (approximately)

-- Dumping structure for table e-learning.nilai_tugas_trainees
...
-- Dumping data for table e-learning.nilai_tugas_trainees: ~0 rows (approximately)

-- Dumping structure for table e-learning.password_resets
...
-- Dumping data for table e-learning.password_resets: ~0 rows (approximately)

-- Dumping structure for table e-learning.pengumumans
...
-- Dumping data for table e-learning.quizs: ~2 rows (approximately)
...
-- Dumping structure for table e-learning.sms_gateways
...
-- Dumping data for table e-learning.sms_gateways: ~0 rows (approximately)

-- Dumping structure for table e-learning.soals
...
-- Dumping data for table e-learning.soals: ~2 rows (approximately)
...
-- Dumping structure for table e-learning.soal_has_quizs
...
-- Dumping data for table e-learning.trainees: ~2 rows (approximately)
...
-- Dumping structure for table e-learning.trainee_jawab_quiz_essays
...
-- Dumping data for table e-learning.trainee_jawab_quiz_essays: ~0 rows (approximately)

-- Dumping structure for table e-learning.trainee_jawab_quiz_pilgans
...
-- Dumping data for table e-learning.trainee_jawab_quiz_pilgans: ~0 rows (approximately)

-- Dumping structure for table e-learning.trainee_jawab_tugas
...
-- Dumping data for table e-learning.trainee_jawab_tugas: ~0 rows (approximately)
...
-- Dumping structure for table e-learning.trainers
...
-- Dumping data for table e-learning.trainers: ~6 rows (approximately)
...
-- Dumping structure for table e-learning.tugass
...
-- Dumping data for table e-learning.tugass: ~0 rows (approximately)
...
-- Dumping structure for table e-learning.users
...
-- Dumping data for table e-learning.users: ~8 rows (approximately)
